...
const CookiePolicy = () => {
  return (
    <Layout className="min-h-screen bg-gray-100 mt-20 md:mt-12">
      <Content className="p-4 md:p-8 lg:p-16">
        <div className="bg-white p-4 md:p-8 lg:p-12 rounded-lg shadow-md">
          <Title level={2} className="text-center mb-6 md:mb-8">Cookie Policy</Title>
          ...
          <Title level={3} className="mt-6 md:mt-8">1. What Are Cookies?</Title>
          <Paragraph>
          ...
          <Title level={3} className="mt-6 md:mt-8">2. How We Use Cookies</Title>
          <Paragraph>
          ...
          <Title level={3} className="mt-6 md:mt-8">3. Types of Cookies We Use</Title>
          <Paragraph>
          ...
          <Title level={3} className="mt-6 md:mt-8">4. Managing Cookies</Title>
          <Paragraph>
          ...
          <Title level={3} className="mt-6 md:mt-8">5. Third-Party Cookies</Title>
          <Paragraph>
          ...
          <Title level={3} className="mt-6 md:mt-8">6. Changes to This Cookie Policy</Title>
          <Paragraph>
          ...
          <Title level={3} className="mt-6 md:mt-8">7. Contact Us</Title>
          <Paragraph>
